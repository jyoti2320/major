...
<div class="row">
   ...
   <center style="font-size:1.3rem; color:#f3722c; font-weight:500;">Aided College Form</center>
      <div class="boc">
            <div class="row">
      ...
      <form method="post">
              ...
              <div class="row" style="padding-top: 10px;">
                  <div class="col-md-4"><input type="submit" name="aid_college" value="Add Aided-College" style="color: #fff; background: #f8961e;" class="btn"></div>
...
<?php
if(isset($_REQUEST["aid_college"]))
{
    extract($_REQUEST);
    $con=mysqli_connect("localhost","root","","jdmeerut_jdmeerut");
    $s="INSERT INTO `aid_college`(`name`, `address`, `course`, `seat`, `website`) VALUES ('$name','$address','$course','$seat','$website')";
    mysqli_query($con, $s);
...
<tr>
    ...
    <td>
    <a href="delete15.php?id=<?php echo $p[0]; ?>" name="delete11" style="color: #fff; background: violet;" class="btn">Delete</a>
    </td>
</tr>
<?php
}
