...
<div class="row">
   ...
   <center style="font-size:1.3rem; color:#f3722c; font-weight:500;">Government College Form</center>
      <div class="boc">
            <div class="row">
      ...
      <form method="post">
              ...
              <div class="row" style="padding-top: 10px;">
                  <div class="col-md-4"><input type="submit" name="gcollege" value="Add G-College" style="color: #fff; background: #f8961e;" class="btn"></div>
...
<?php
if(isset($_REQUEST["gcollege"]))
{
    extract($_REQUEST);
    $con=mysqli_connect("localhost","root","","jdmeerut_jdmeerut");
    $s="INSERT INTO `gcollege`(`name`, `address`, `course`, `seat`, `website`) VALUES ('$name','$address','$course','$seat','$website')";
    mysqli_query($con, $s);
...
<tr>
    ...
    <td>
    <a href="delete13.php?id=<?php echo $p[0]; ?>" name="delete11" style="color: #fff; background: violet;" class="btn">Delete</a>
    </td>
</tr>
<?php
}
