...
$query="select * from atpo where id='$id'";
...
{
extract($_REQUEST);
$sql="UPDATE `atpo` SET `name`='$name',`year`='$year',`nop`='$nop',`pno`='$pno',`email`='$email',`not`='$not',`designation`='$designation',`mno`='$mno' where id=$id ";
//echo $sql;
