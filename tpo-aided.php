...
<head>
  ...
  <title>Government Colleges TPO</title>
...
<?php include 'header.php'; ?> 
  ...
  <section style="background-color: #af4275;">
    <div class="container inner-div p-0" style="background-color: #fff;overflow-x:auto;">
      <div class="row ml-0 mr-0">
        <h1 class="col-heading" style="text-align: center;">
